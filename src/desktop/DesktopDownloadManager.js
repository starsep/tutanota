...
export class DesktopDownloadManager {
	...
	async downloadBlobNative(fileName: string, headers: {|v: string, accessToken: string|}, blobs: Array<{blobId: BlobId, accessInfo: BlobAccessInfo}>): Promise<NativeDownloadResult> {
