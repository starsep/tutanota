...
import type {MailRecipientsTextField} from "../../mail/editor/MailRecipientsTextField"
...
export async function showCalendarEventDialog(
	...
	const {MailRecipientsTextField} = await import("../../mail/editor/MailRecipientsTextField")
	...
	const renderInvitationField = (): Children => (viewModel.canModifyGuests() ? renderAddAttendeesField(invitationFieldText, viewModel, MailRecipientsTextField) : null)
...
function renderAddAttendeesField(
	...
	// eew
	recipientsTextFieldComponent: Class<MailRecipientsTextField>
): Children {
	return m(recipientsTextFieldComponent, {
